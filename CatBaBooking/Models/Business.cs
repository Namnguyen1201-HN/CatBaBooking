...
public partial class Business
{
    ...
    public Business() { }
    public Business(int businessId, int ownerId, string name, string type, string address,
    string description, string status, DateTime? createdAt, DateTime? updatedAt)
    {
